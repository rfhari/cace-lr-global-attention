...
from .global_attention import NonlocalInteraction
...
class Cace(nn.Module):
    ...
    def forward(
        ...
        print("data:", data["edge_index"].shape)
        print("n_nodes:", data["batch"].shape)
        ...
        print("node_feat_A:", node_feat_A.shape)
        ...
        # global_node_feat_B = self.nonlocal_interaction(node_feat_B, data["batch"])
        # node_feats_list.append(global_node_feat_B)
